package com.mzh.emock.type.object.definition;

import com.mzh.emock.exception.EMDefinitionException;
import com.mzh.emock.type.EMock;
import com.mzh.emock.type.IDObject;
import com.mzh.emock.type.object.EMObjectWrapper;
import com.mzh.emock.util.EMDefinitionUtil;
...
import com.mzh.emock.type.object.method.EMMethodInvoker.*;

/**
 * @author mzh
 * the mock object definition sources
 * which class and which method should be used to create mocked object
 * the method return a {@link com.mzh.emock.type.object.EMObjectWrapper }
...
public class EMDefinition<T, A> extends IDObject {
    ...
    private final SimpleInvoker<EMObjectWrapper<T>, Supplier<A>> methodInvoker = new SimpleInvoker<EMObjectWrapper<T>, Supplier<A>>() {
        @Override
    ...
    public SimpleInvoker<EMObjectWrapper<T>, Supplier<A>> getMethodInvoker() {
